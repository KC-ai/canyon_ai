-- Canyon.ai CPQ Database Setup for Supabase (Complete Clean Version)
-- Run this in your Supabase SQL Editor

-- Drop all indexes first
DROP INDEX IF EXISTS idx_quotes_created_by CASCADE;
DROP INDEX IF EXISTS idx_quotes_status CASCADE;
DROP INDEX IF EXISTS idx_quotes_workflow_id CASCADE;
DROP INDEX IF EXISTS idx_quote_items_quote_id CASCADE;
DROP INDEX IF EXISTS idx_workflows_quote_id CASCADE;
DROP INDEX IF EXISTS idx_workflows_user_id CASCADE;
...
DROP POLICY IF EXISTS "Users can manage their quote items" ON quote_items;
DROP POLICY IF EXISTS "Users can manage their own workflows" ON workflows;
DROP POLICY IF EXISTS "Users can manage their workflow steps" ON workflow_steps;
